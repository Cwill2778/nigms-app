  ...
  return (
    <div className="w-full bg-[#0A0A0A] min-h-screen pb-24">
      ...
      <section className="max-w-4xl mx-auto px-4 text-center">
        <div className="bg-[#111111] border border-white/10 p-8 md:p-12 rounded-xl shadow-2xl text-left">
          ...
          <h2 className="text-3xl text-white font-heading font-bold uppercase tracking-wider mb-6 border-b border-white/10 pb-4">What We Fix:</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="flex items-start bg-[#111111] p-6 rounded-lg border border-white/10 hover:border-brand-gold/50 transition-colors">
              <span className="text-brand-gold text-3xl mr-4">🔨</span>
              <div>
                <strong className="text-white text-xl block mb-2 uppercase font-heading tracking-wide">Carpentry & Woodwork</strong>
                <span className="text-[#a0a0a0]">Deck repairs, porch restoration, and custom trim.</span>
              </div>
            </div>
            <div className="flex items-start bg-[#111111] p-6 rounded-lg border border-white/10 hover:border-brand-gold/50 transition-colors">
              <span className="text-brand-gold text-3xl mr-4">🖌️</span>
              <div>
                <strong className="text-white text-xl block mb-2 uppercase font-heading tracking-wide">Drywall & Paint</strong>
                <span className="text-[#a0a0a0]">Patching holes, fixing water damage, and seamless touch-ups.</span>
              </div>
            </div>
            <div className="flex items-start bg-[#111111] p-6 rounded-lg border border-white/10 hover:border-brand-gold/50 transition-colors">
              <span className="text-brand-gold text-3xl mr-4">🚪</span>
              <div>
                <strong className="text-white text-xl block mb-2 uppercase font-heading tracking-wide">Doors & Windows</strong>
                <span className="text-[#a0a0a0]">Realigning doors, fixing locks, and replacing worn weatherstripping.</span>
              </div>
            </div>
            <div className="flex items-start bg-[#111111] p-6 rounded-lg border border-white/10 hover:border-brand-gold/50 transition-colors">
              <span className="text-brand-gold text-3xl mr-4">🔧</span>
              <div>
                <strong className="text-white text-xl block mb-2 uppercase font-heading tracking-wide">General Handyman Services</strong>
                <span className="text-[#a0a0a0]">Fixture installation, TV mounting, and furniture assembly.</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-24">
        <h2 className="text-3xl md:text-5xl text-white font-heading font-bold uppercase tracking-wider mb-6 text-center">
          Our Recent Projects
        </h2>
        <div className="h-1 w-24 bg-brand-gold text-[#0A0A0A] mx-auto mb-16"></div>
        
        {/* Before and After Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-[#111111] border border-white/10 rounded-xl overflow-hidden shadow-xl group">
            ...
            <div className="p-6">
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Deck Restoration</h3>
              <p className="text-[#a0a0a0] text-sm">Stripping, sanding, and re-staining to bring weathered wood back to life.</p>
            </div>
          </div>

          <div className="bg-[#111111] border border-white/10 rounded-xl overflow-hidden shadow-xl group md:-translate-y-4">
            <div className="relative h-64 overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Deck Rebuild</h3>
              <p className="text-[#a0a0a0] text-sm">Full structural tear-down and rebuild for safety and outdoor enjoyment.</p>
            </div>
          </div>
          ...
          <div className="bg-[#111111] border border-white/10 rounded-xl overflow-hidden shadow-xl group">
            ...
            <div className="p-6">
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Custom Built-Ins</h3>
              <p className="text-[#a0a0a0] text-sm">Transforming dead space into a functional, beautiful custom mini-bar.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="relative rounded-xl overflow-hidden shadow-xl group h-80">
            ...
            <div className="absolute bottom-0 left-0 p-8">
              <span className="inline-block bg-brand-gold text-[#0A0A0A] text-wood-900 px-3 py-1 rounded text-xs font-bold uppercase tracking-wider mb-2">Outdoor Living</span>
              <h3 className="text-2xl text-white font-heading font-bold uppercase tracking-wider">Patio Upgrades</h3>
            </div>
          </div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-xl group h-80">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-wood-900 via-wood-900/40 to-transparent"></div>
            <div className="absolute bottom-0 left-0 p-8">
              <span className="inline-block bg-brand-gold text-[#0A0A0A] text-wood-900 px-3 py-1 rounded text-xs font-bold uppercase tracking-wider mb-2">Fixture Upgrades</span>
              <h3 className="text-2xl text-white font-heading font-bold uppercase tracking-wider">Exterior Fans & Lighting</h3>
            </div>
          </div>
        </div>
      </section>
