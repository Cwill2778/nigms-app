    ...
    <div className="w-full bg-[#0A0A0A] min-h-screen pb-24">
      <section className="max-w-4xl mx-auto px-4 py-24 text-center">
        ...
        <div className="bg-[#111111] border border-white/10 p-8 md:p-12 rounded-xl shadow-2xl text-left mb-16">
          ...
          <h2 className="text-3xl text-white font-heading font-bold uppercase tracking-wider mb-8 border-b border-white/10 pb-4">Appliances We Service</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-[#111111] border-t-4 border-brand-gold p-6 rounded shadow-lg text-center">
              <div className="text-5xl mb-4">🍳</div>
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Kitchen</h3>
              <p className="text-[#a0a0a0]">Refrigerators, freezers, ovens, ranges, and dishwashers.</p>
            </div>
            <div className="bg-[#111111] border-t-4 border-brand-gold p-6 rounded shadow-lg text-center">
              <div className="text-5xl mb-4">🧺</div>
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Laundry</h3>
              <p className="text-[#a0a0a0]">Washing machines and dryers (including vent cleanings).</p>
            </div>
            <div className="bg-[#111111] border-t-4 border-brand-gold p-6 rounded shadow-lg text-center">
              <div className="text-5xl mb-4">🚰</div>
              <h3 className="text-xl text-white font-heading font-bold uppercase tracking-wider mb-2">Utility</h3>
              <p className="text-[#a0a0a0]">Water heaters and garbage disposals.</p>
            </div>
          </div>
        ...
        <p className="text-lg text-[#a0a0a0] text-center mb-10 max-w-2xl mx-auto">If you are experiencing any of these common issues, don't wait for a total failure. Call us to diagnose the problem before it requires a full replacement.</p>
        
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Fridge not cooling</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Dryer not heating</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Washer leaking</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Oven won't ignite</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Dishwasher not draining</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Noisy spin cycle</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Ice maker broken</p>
          </div>
          <div className="bg-[#111111]/80 border border-white/10 p-4 rounded text-center hover:border-brand-gold/50 transition-colors">
            <p className="text-white font-bold">Strange burning smells</p>
          </div>
        </div>
      </section>
    </div>
